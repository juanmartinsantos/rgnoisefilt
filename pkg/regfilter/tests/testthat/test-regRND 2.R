...
test_that("Invalid threshold value", {
  ...
  # Default method
  expect_error(regRND(x = rock[,-ncol(rock)], y = rock[,ncol(rock)], t=2))
  # Class formula method
  expect_error(regRND(formula = perm ~ ., data = rock, t=2))
})
...
test_that("Invalid nfolds value", {
  ...
  # Default method
  expect_error(regRND(x = rock[,-ncol(rock)], y = rock[,ncol(rock)], nfolds=1))
  # Class formula method
